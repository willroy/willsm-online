<div id="imagemodalback" class="hidden relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true" onclick="$('#imagemodalback').hide();$('#imagemodal').hide();">
<div class="fixed inset-0 bg-gray-100/75 transition-opacity" aria-hidden="true"></div>
<div id="imagemodal" class="hidden fixed inset-0 z-50 w-screen">
