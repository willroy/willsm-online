<div id="videomodalback" class="hidden relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" onclick="$('#videomodalback').hide();$('#videomodal').hide();">
<div class="fixed inset-0 bg-gray-100/75 transition-opacity" aria-hidden="true"></div>
<div id="videomodal" class="hidden fixed inset-0 z-10 w-screen">
