...
@section('content')
	<div class="grid grid-cols-2 gap-4">
      ...
      <div class="animate-fadein opacity-0">@include('dashboard.inc.music')</div>
      <div class="animate-fadein opacity-0">@include('dashboard.inc.projects')</div>
      <div class="animate-fadein opacity-0">@include('dashboard.inc.aboutme')</div>
   </div>
@endsection

@section('footer')
   <div class="animate-fadein opacity-0 w-full h-auto flex items-center justify-center gap-2 flex-wrap mt-4">
